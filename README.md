...
* **Temporal Causal Graph (v4):** Beyond instantaneous edge attribution, Arminta discovers delayed effects at 1-, 2-, 3-, and 5-step lag offsets. ![Lag Pairs](https://img.shields.io/badge/dynamic/json?url=https://gist.githubusercontent.com/mematron/27ec34034b4aed5d2cdd7563738fe5be/raw/arminta_stats.json&query=$.causal_edges&label=lag%20pairs&color=blue&cacheSeconds=300) currently attributed — actions whose effects appear seconds later rather than within the 300ms measurement window are now fully tracked.
